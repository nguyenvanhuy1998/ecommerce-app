  ...
  return (
    <ScrollView style={dynamicStyles.container}>
      <View style={dynamicStyles.profileSection}>
        ...
        <Text style={dynamicStyles.name}>{user?.name || 'Gilbert Jones'}</Text>
        <Text style={dynamicStyles.email}>{user?.email || 'Gilbertjones001@gmail.com'}</Text>
      ...
      <View style={dynamicStyles.menuSection}>
        <TouchableOpacity 
          style={[dynamicStyles.menuItem, dynamicStyles.menuItemFirst]}
        ...
        >
          ...
          <Ionicons name="chevron-forward" size={20} style={dynamicStyles.chevron} />
        </TouchableOpacity>
        ...
        <View style={dynamicStyles.themeSection}>
          <Text style={dynamicStyles.themeSectionTitle}>Appearance</Text>
          
          <TouchableOpacity 
            style={[dynamicStyles.themeOption, dynamicStyles.themeOptionFirst]}
            onPress={useSystemTheme}
          >
            <Ionicons name="phone-portrait-outline" size={24} color={theme.colors.text} />
            <Text style={dynamicStyles.themeOptionText}>Use System Setting</Text>
            {themePreference === 'system' && (
              <View style={dynamicStyles.themeOptionSelected}>
                <View style={dynamicStyles.themeOptionSelectedInner} />
              </View>
            )}
          </TouchableOpacity>
